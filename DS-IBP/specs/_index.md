...
|---|---|---|---|---|
| AllocationBar | specs/AllocationBar.md | styles/allocation-bar.css | alert, button | 1.002 |
| Alert | specs/Alert.md | styles/alert.css | button, link | 1.010 |
| Avatar | specs/Avatar.md | styles/avatar.css | badge | 1.005 |
| Badge | specs/Badge.md | styles/badge.css | — | 1.003 |
| Breadcrumbs | specs/Breadcrumbs.md | styles/breadcrumbs.css | link, context-menu, tooltip | 1.006 |
| ButtonGroup | specs/ButtonGroup.md | styles/button-group.css | button | 1.005 |
| Buttons | specs/Buttons.md | styles/button.css | spinner | 1.011 |
| Chart | specs/Chart.md | styles/chart.css | tooltip, alert, skeleton, segment-control, icon-button, button, table-cell | 1.003 |
...
| DropdownList | specs/DropdownList.md | styles/dropdown-list.css | checkbox, label-helper, spinner | 1.013 |
...
| InputText | specs/InputText.md | styles/input.css | label-helper, tooltip, chip | 1.013 |
...
| LabelHelper | specs/LabelHelper.md | styles/label-helper.css | checkbox, radio, switch | 1.006 |
...
| NavPanel | specs/NavPanel.md | styles/nav-panel.css | icon-button, badge, avatar | 1.020 |
...
| ReadOnlyField | specs/ReadOnlyField.md | styles/read-only-field.css | label-helper, chip, link, tooltip, segment-control, splitter | 1.008 |
| RiskMetric | specs/RiskMetric.md | styles/riskmetric.css | chip, popover, icon-button, divider, skeleton | 1.007 |
| SegmentControl | specs/SegmentControl.md | styles/segment-control.css | tab, button, button-group, badge | 1.006 |
| Skeleton | specs/Skeleton.md | styles/skeleton.css | — | 1.002 |
| SnackBar | specs/SnackBar.md | styles/snackbar.css | button, link | 1.005 |
...
| TableCell | specs/TableCell.md | styles/table-cell.css | checkbox, chip, icon-button, button, tooltip, chart | 2.021 |
...
| Tile | specs/Tile.md | styles/tile.css | icon-button, button, link, chip, badge, alert, divider | 1.013 |
...
| Страница | Спека | Файл | Версия |
|---|---|---|---|
| Backlog | — | pages/rnd/Backlog.html | — |
