...
- **Названия модалок** — редполитика (утвердительная форма, sentence case, без точки, имена сущностей не склоняем) — черновик в разделе «Бэклог» страницы.
...
| `.modal` | Контейнер: фон, радиус 8px (--radius-modal), тень (--shadow-modal-form), flex-колонка, max-height 80vh |
