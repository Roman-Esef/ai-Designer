...
**Инварианты:** не самостоятельный компонент, без своего контейнера — только в составе родителя. Текст Label — одна строка с многоточием; перенос до 2 строк — только модификатором `.ds-label--wrap` (узкие колонки).
