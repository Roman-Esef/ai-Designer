...
window.IBPHub = [
  ...
  {
    /* Кит локальных компонентов направления Post. Стоит в колонке «Дизайн-
       система», а не «Проекты»: это витрина компонентов, вторая точка входа в
       документацию, а не экран продукта. Решение человека 20.09.2026.
       root null — как у ДС: сами файлы лежат внутри root записи 'post', и
       своя папка записи этой строке не нужна. */
    id: 'post-kit',
    group: 'ds',
    title: 'Локальные компоненты Post',
    desc: 'Кит направления: компоненты сделки и переиспользуемые',
    href: 'Projects/post/post_local_components/index.html',
    root: null,
    icon: 'layout-grid-01'
  },
  {
